...
class SecondAggregateData:
    ...
    def __init__(self, cimulative_item=None):
        self.cases = {}  # dict of SecondAggregateDataItem (cases as keys)
        self.time = None
        self.overall = SecondAggregateDataItem()
        self.cumulative = cimulative_item  # SecondAggregateDataTotalItem
...
class SecondAggregateDataItem:
    ...
    def __init__(self):
        ...
        self.http_codes = {}
        self.net_codes = {}
        self.times_dist = []  # array of dicts: from, to, count
        self.quantiles = {}
        self.dispersion = 0
        self.input = 0
        self.output = 0
